    ...
    */
    ...
    render() {
        return(
            <div id="background">
                <div>
                    <h3 className="table-title">Item List</h3>
                ...
                <div>
                    <h3 className="table-title">Jobs List</h3>
                    <table className="table">
                        <thead>
                            <tr id="table-titles">
                                <th>Job</th>
                            ...
                            this.state.jobs.map(
                                            job =>
                                                <tr key={job.id} className="each-table">
                                                    ...
                                                    <button className="btn btn-warning" 
                                                        onClick={() => this.updateJobById(job.id)}>Edit</button></td>
                                                </tr>
